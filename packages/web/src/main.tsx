...
function renderWebAuthCallbackPage(): void {
  document.title = "Polaris - Sign In";
...
async function renderConversationSharePage(): Promise<void> {
  ...
  document.title = routeLocale === "zh-CN" ? "Polaris 会话分享" : "Polaris Conversation Share";
...
async function bootstrapWebApp() {
  ...
  try {
    ...
    document.title = "Polaris - Web + Server";
