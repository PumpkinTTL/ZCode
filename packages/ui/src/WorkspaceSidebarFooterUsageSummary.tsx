...
export function WorkspaceSidebarFooterUsageSummary({
  ...
  // state 仍在本组件内计算：用量入口的可见性由 useCodingPlanEntryGate 等内部状态决定。
  void state;
  return <WorkspaceSidebarFooterUsageSummaryContent onUsageClick={onUsageClick} />;
}
...
export function WorkspaceSidebarFooterUsageSummaryContent({
  ...
  return (
    <>
      ...
      {/* 官方套餐升级/续费入口（会打开官方购买页）已随官方账号业务整体砍除。 */}
    </>
  );
}
