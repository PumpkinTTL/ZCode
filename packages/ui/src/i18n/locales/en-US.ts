...
const enUS: Record<string, string> = {
  ...
  "occupationOnboarding.modeDescription": "How would you like Polaris to show its work?",
  ...
  "startup.global.silent": "Starting Polaris",
  ...
  "startup.global.servicesFailed":
    "Local data is ready, but app services failed to start. Copy the diagnostics, then exit and reopen Polaris.",
  ...
  "startup.global.starting_services": "Starting Polaris",
  "startup.global.ready": "Local data is ready",
  "startup.global.failed": "Startup preparation failed",
  "startup.global.help":
    "Polaris will open when preparation finishes. Large histories may take longer. Please keep the app running.",
  ...
  "startup.global.error.lock_timeout":
    "Waiting for the database write lock timed out. Another Polaris or CLI process may be updating data. Retry after it finishes.",
  ...
  "startup.global.error.startup_status_timeout":
    "No startup status was received. Exit and reopen Polaris. If it fails again, provide the diagnostics to support.",
  "startup.global.error.transport_closed":
    "The preparation process exited or disconnected. Exit and reopen Polaris to check the migration records again.",
  "startup.global.error.unsupported_runtime":
    "The configured Agent does not support storage preparation. Restore the bundled Agent, then reopen Polaris.",
  ...
  "settings.computerUse.disabledToast":
    "Computer Use is disabled. Existing conversations require a Polaris restart to take effect.",
  ...
  "conversationShare.permission.linkEditorHint": "Import into Polaris",
  ...
  "conversationShare.import.loginRequired":
    "This share cannot be imported anonymously. Sign in to Polaris and try again",
  ...
  "logout.confirm.title": "Disconnect and restart Polaris?",
  ...
  "modelTrajectory.empty": "No model calls recorded (only Polaris Agent writes model-io)",
  ...
  "titleBar.menu.help.about": "About Polaris",
  ...
  "forceUpdate.title": "Update Polaris to continue",
  ...
  "workspaceSidebar.unavailableLocalDirectory":
    "The workspace directory does not exist or cannot be accessed. You can only view history for now. Restore the directory and restart Polaris to continue.",
  ...
  "ssh.assetInstallModeDescription":
    "Remote server download reduces upload waiting, but the server must reach the Polaris CDN and have download, extract, and checksum tools.",
  ...
  "chat.changeSummary.rewindDialog.description":
    "Polaris checks current file content again before writing. If another process changed a file, no files will be written.",
  ...
  "settings.terminalFontFamilyDescription":
    "Leave blank to auto-detect system terminal settings; set a value to override the Polaris terminal font.",
  ...
  "settings.zcodeInteractionBehaviorDescription":
    "While Polaris is running, add follow-up actions to the queue or guide them to run after the next tool call.",
  ...
  "settings.dataBaseDirForbiddenInstallDir":
    "The data directory cannot be the Polaris installation folder on Windows. Choose a folder outside the app install location.",
  ...
  "settings.migration.sectionDescription":
    "Scan native Claude Code history on this machine, optionally filter by workspace and activity window, then import the selected sessions into their matching Polaris task lists.",
  ...
  "resourceManager.storage.summaryTotal": "Total used by Polaris",
  ...
  "resourceManager.storage.diskUsage": "Polaris uses {used}",
  ...
  "settings.browser.desktopOnly": "Browser data can only be managed in the Polaris desktop app.",
  ...
  "settings.browser.import.helperVerificationFailed":
    "Polaris could not verify its Windows secure import component. Reinstall or update Polaris before importing cookies.",
  ...
  "settings.browser.import.adminConfirmDescription":
    "Chrome protects cookies with App-Bound encryption on Windows. For this import only, Polaris will request administrator access, start a temporary system service, and delete it immediately afterward. Chrome passwords are never read or imported.",
  ...
  "settings.mcp.description": "Manage MCP server configurations used by Polaris Agent.",
  ...
  "settings.mcp.host.activeDescription":
    "Polaris provides this MCP server for the {pluginName} plugin. Its runtime identity is managed by the host.",
  ...
  "settings.mcp.statusOnlyUnsupported":
    "This Polaris Agent cannot refresh OAuth status. Upgrade or restart Polaris, then reopen MCP settings to run a full refresh.",
  ...
  "settings.mcp.failure.not_authenticated":
    "You are not signed in. Sign in to Polaris to use this MCP server.",
  ...
  "settings.mcpServers.import.importing": "Importing MCP servers into Polaris",
  ...
  "settings.modelProvider.startPlan.highlight.trial.description":
    "Timing starts after signing in to Polaris 3.x.",
  ...
  "settings.modelProvider.startPlan.compatibility":
    "Supports BYOK and BYOA. Base URL, API format, and API Key are maintained by Polaris automatically.",
  ...
  "settings.modelProvider.codingPlan.purchase.teamMemberNoticeDescription":
    "Add yourself or other members on the BigModel team plan management page. Once assigned, the team quota will be available in Polaris.",
  ...
  "settings.usage.billingBanner.description":
    "Connect your {provider} account to query Coding Plan entitlement, then keep coding in Polaris after purchase or setup.",
  ...
  "settings.usage.entitlementServerMcpUsage": "Polaris MCP",
  ...
  "settings.skills.import.mode.copy.description":
    "Copy the full skill directory into Polaris. Later changes in the external agent directory will not sync automatically.",
  "settings.skills.import.mode.symlink.description":
    "Create a directory link to the external agent skill. Polaris follows later source changes, but the skill depends on that source path remaining available.",
  "settings.skills.import.importing": "Importing skills into Polaris",
  ...
  "settings.subagents.description":
    "Manage user-level subagent Markdown files consumed by Polaris Agent.",
  ...
  "settings.plugins.store.subtitle":
    "Extend Polaris with skills, commands, and MCP servers from plugins",
  ...
  "settings.plugins.import.mode.copy.description":
    "Copy the full plugin directory into Polaris and register it in plugins.dirs. Later changes in the external agent directory will not sync automatically.",
  "settings.plugins.import.mode.symlink.description":
    "Create a directory link to the external agent plugin and register it in plugins.dirs. Polaris follows later source changes, but the plugin depends on that source path remaining available.",
  "settings.plugins.import.importing": "Importing plugins into Polaris",
  ...
  "settings.commands.description":
    "Manage Polaris Agent .md command files. Commands can be invoked with /command-name in chat.",
  "settings.commands.sourceFilterLabel": "Source filter",
  "settings.commands.source.zcodeAgent": "Polaris Agent",
  ...
  "settings.commands.import.mode.copy.description":
    "Copy the command file into Polaris. Later changes in the external agent file will not sync automatically.",
  "settings.commands.import.mode.symlink.description":
    "Create a file link to the external agent command. Polaris follows later source changes, but the command depends on that source path remaining available.",
  "settings.commands.import.importing": "Importing commands into Polaris",
  ...
  "settingsSync.action.finish": "Start using Polaris",
  "settingsSync.agent.zcode": "Polaris Agent",
  ...
  "settingsSync.discovery.helper":
    "Only missing items will be imported and your current Polaris settings will not be overwritten.",
  ...
  "onboarding.dialog.title": "Welcome to Polaris",
  ...
  "onboarding.welcome.title": "Welcome to Polaris",
  "onboarding.welcome.start": "Start Polaris",
  ...
  "onboarding.stepDescription.migration":
    "Start migration and wait while Polaris imports your selections.",
  ...
  "onboarding.agentsFile.confirmDescription":
    "Polaris will copy {source} to {target}.\nIf the target file already exists, the Polaris default AGENTS configuration will be overwritten.",
  ...
  "chat.placeholder.newTask":
    "Ask Polaris anything, @ to add context, / for commands or capabilities",
  "chat.placeholder.newTaskMobile": "Ask Polaris anything…",
  ...
  "chat.modelSwitch.contextWindowGuard.description":
    "This conversation has used {used} tokens, which exceeds {modelName}'s available context of {target} tokens after reserving maximum output.\nCompress the current conversation with the current model first. If the compressed context fits, Polaris will continue switching models.",
  ...
  "chat.toolbar.computerUse.tooltip.ready":
    "Computer Use ready — just describe what you want Polaris to do",
  ...
  "chat.toolbar.computerUse.tooltip.error":
    "Computer Use enablement failed. Please restart Polaris app and retry, or ask Polaris to investigate the logs",
  ...
  "workflows.hub.empty.hint":
    "Design a workflow with Polaris in chat, then have it save the workflow to a project once it works. Projects that aren't open don't appear here.",
  ...
  "workflows.hub.detail.whenToUse.help":
    "A routing hint for Polaris: when this workflow is the right pick.",
  ...
  "workflows.hub.detail.script.note":
    "The script is read-only. To change it, revise it with Polaris in chat and save a new version.",
  ...
  "chat.slash.emptyUnavailable":
    "No slash commands have been broadcast for the current Polaris Agent session",
  ...
  "chat.quota.mcp.quotaExhausted":
    'Polaris MCP "{server}" has used up today\'s quota. It resets tomorrow.',
  "chat.quota.mcp.codingPlanRequired":
    'No Polaris MCP "{server}" quota. Sign in or get a Coding Plan to use it.',
  ...
  "resourceManager.appUsage": "Polaris",
  ...
  "feedback.submit.template.section.copyErrorHeading": "Polaris Error Info",
  ...
  "offPeak.keepAwakeBanner": "Keep your computer awake while Polaris is running a chat.",
  ...
  "offPeak.form.instructionsPlaceholder":
    "Describe a task Polaris can work on in the background, including the expected result and any constraints…",
  ...
  "chat.cuaReadiness.toolsNotLoaded":
    "Polaris Computer Use is still preparing — its tools aren't loaded yet ({count} loaded). Grant the permissions below; tools appear once the helper is ready.",
  "chat.cuaReadiness.toolsPreparing":
    "Polaris Computer Use is still preparing — its tools aren't loaded yet. Grant the permissions below; tools appear once the helper is ready.",
  ...
  "cuaPermission.modal.relaunchAppButton": "Restart Polaris",
  "cuaPermission.modal.relaunchAppHint":
    "Still not working after restarting Helper? Restart Polaris to fully reload the Helper process.",
  ...
  "cuaPermission.tools.untrustedRuntime":
    "Computer Use tools were found, but they did not come from the verified Polaris plugin. Review the plugin installation, then check again.",
  ...
  "cuaPermission.ready.sessionValidationHint":
    "Polaris will verify the Computer Use tools against the exact session when your first session starts.",
